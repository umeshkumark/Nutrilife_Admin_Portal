 ...
 *
 * file - PlanRoute.js
 * desc - used to handle Diet Plan Routes
 */
...
exports.initRoute = function(curDir,dbConnURI,daoFileName) {
    console.log('PlanRoute#initRoute , Current DIR - ' + curDir );
    mongoDBConnURI = dbConnURI;
    currentDir = curDir;
    var daoPath = path.join(currentDir,'server','dao',daoFileName);
    console.log('PlanRoute#initRoute.Path - ' + daoPath);
    dao = require(daoPath);
...
exports.listDocuments = function(request,response) {
    console.log('PlanRoute#listDocuments');
    dao.listDocuments(function(documentList){
        ...
        response.json({
            status:false,
            list:documentList,
            message:'Could not get the list of Diet Plans'
        });
    });
};
...
exports.saveDocument = function(request,response) {
    console.log('PlanRoute#saveDocument');
    ...
    dao.saveDocument(newDocument,function(savedDocument){
        ...
        dao.listDocuments(function(documentList){
            response.json({
                status:true,
                list:documentList,
                message:'Successfully saved the Diet Plan'
            });
        },function(error){
            console.log('Sending empty Document List');
            response.json({
                status:false,
                message:'Could not save the Diet Plan'
            });
        });
    },function(error){
...
exports.updateDocument = function(request,response){
    console.log('PlanRoute#updateDocument');
    var documentJSON = request.body;
    console.dir(documentJSON);
    ...
    dao.updateDocument(updatedDocument,documentID,function(updatedDocument){
        ...
        dao.listDocuments(function(documentList){
            response.json({
                status:true,
                list:documentList,
                message:'Successfully updated the Diet Plan'
            });
        },function(error){
            console.log('Sending empty Document List');
            response.json({
...
exports.deleteDocument = function(request,response){
    console.log('PlanRoute#deleteDocument');
    var documentID = request.params.ID;
    console.log('Document ID - ' + documentID);
    dao.deleteDocument(documentID,function(){
        ...
        dao.listDocuments(function(documentList){
            response.json({
                status:true,
                list:documentList,
                message:'Successfully deleted the Diet Plan'
            });
        },function(error){
            console.log('Sending empty Document List');
            response.json({
                status:false,
                message:'Could not delete the Diet Plan'
            });
        });
    },function(error){
